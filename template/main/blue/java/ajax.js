...
for( i = 1; i <= rate; i++) {
document.getElementById('my_rate_'+id+'_'+i+'').src = "template/main/blue/img/rate_on.gif";
}
}
function show_rate_off( id , rate){
for( i = 1; i <= rate; i++) {
document.getElementById('my_rate_'+id+'_'+i+'').src ="template/main/blue/img/rate_off.gif";
}
}
function rate_send( id , rate ){
connect('rate.php',"id="+id+"&rate="+rate,"rate_"+id,"<img border='0' src='template/main/blue/img/loading.gif'>");
}
function vote_send( id , ac ,voteid){
connect('rate.php',"task=vote&ac="+ac+"&id="+id+"&voteid="+voteid ,"vote","<center>لطفا صبر کنید.<br><img border='0' src='template/main/blue/img/load.gif'></center>");
}
      function Rashimg(type) {
